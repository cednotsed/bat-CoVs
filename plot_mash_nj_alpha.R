...
ggsave("results/alpha_circle.png",
       plot = p_circle,
       dpi = 300,
       width = 10,
       height = 10)

ggsave("results/alpha_tree.linear.pdf",
       plot = p_linear,
       dpi = 300,
       width = 20,
       height = 20)
...
write.tree(annot_tree, "data/trees/alpha_merged.050422.rooted.annotated.tree")
