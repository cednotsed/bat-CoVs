...
sarbe <- readAAStringSet("data/alignments/sarbecovirus_spikes.faa.aln", format = "fasta")
...
writeXStringSet(sarbe_no_gaps, "data/alignments/sarbecovirus_no_gaps.faa.aln")
...
writeXStringSet(contact, "data/alignments/SARS-Cov-2_contact_residues.faa.aln")
...
writeXStringSet(cov1_contact, "data/alignments/SARS-CoV-1_contact_residues.faa.aln")

## MERS ##
MERS <- readAAStringSet("data/alignments/MERS_spikes.faa.aln", format = "fasta")
...
writeXStringSet(MERS_contact, "data/alignments/MERS_contact_residues.faa.aln")
